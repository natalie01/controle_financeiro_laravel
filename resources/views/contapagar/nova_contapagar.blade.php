     ...
     <div class="col-md-6">
             <div class="form-group">
               <label>Data Emissao</label><br />
		   						 <input type="date" name="dataemissao" value="{{ old('dataemissao') }}"/>
	 	   			 </div>
          </div>
     <div class="col-md-6">
             <div class="form-group">
		           <label>Data Vencimento:</label><br />
				 			 <input type="date" name="datavencimento" value="{{ old('datavencimento') }}"/>
 	    			</div>
     </div>
   </div> <!--row-->
  	...
  	<div class="row">
		  ...
		  <div class="col-md-6">
		     <div class="form-group">
		      ...
		      <input type="text" name="credor" value="{{ old('credor') }}" />  
		    	</div>
       </div>
