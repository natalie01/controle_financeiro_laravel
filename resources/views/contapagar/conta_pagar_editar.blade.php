...
<h2>Conta a Pagar</h2>
 ...
 <div class="row">
     ...
     <form action="{{route('contapagar.update',$c->id)}}" id="form1" class="form-horizontal"  method="post">
			    <input type="hidden" name="_method" value="PUT">
					<input type="hidden" name="_token" value="{{{ csrf_token() }}}" />
          <input type="hidden" name="msg" value="conta a pagar atualizada" />  
 ...
 <div class="row">
   ...
   <div class="row">
     <div class="col-md-6">
             <div class="form-group">
               <label>Data Emissao</label><br />
		   						 <input type="date" name="dataemissao" value="{{  $c->dataemissao }}"/>
	 	   			 </div>
          </div>
     <div class="col-md-6">
             <div class="form-group">
		           <label>Data Vencimento:</label><br />
				 			 <input type="date" name="datavencimento" value="{{ $c->datavencimento }}"/>
 	    			</div>
     </div>
   </div> <!--row-->
  	...
  	<div class="row">
		  ...
		  <div class="col-md-6">
		     <div class="form-group">
		      ...
		      <input type="text" name="credor" value="{{  $c->credor }}" />  
		    	</div>
       </div>
    ...
    <br>
    <div class="row">
    <a href = "/contapagar" class = "btn btn-danger">Cancelar</a>
     </div> <!--row-->
 </div>
